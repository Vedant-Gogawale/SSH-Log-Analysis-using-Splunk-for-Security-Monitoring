...
This project focuses on analyzing SSH authentication logs to detect suspicious login activities using Splunk. Logs generated from an Ubuntu system were collected and ingested into Splunk to monitor SSH login attempts, detect brute-force attacks, and identify unauthorized access attempts.

The project simulates a Security Operations Center (SOC) environment where log data is monitored to detect potential security incidents.
